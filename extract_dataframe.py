...
class TweetDfExtractor:
    ...
    def get_tweet_df(self, save=True)->pd.DataFrame:
        columns = ['created_at', 'source', 'original_text','polarity','subjectivity', 'lang', 'favorite_count', 'retweet_count', 
            'original_author', 'followers_count','friends_count','sensetivity', 'hashtags', 'user_mentions', 'place']
        ...
        if save:
            df.to_csv('C:/Users/samuel/Desktop/10academy/Twitter-Data-Analysis/data/Economic_Twitter_Data.json.csv', index=False)
            print('Successfully Saved.')

        return df
if __name__ == "__main__":
    _, tweet_list = read_json("C:/Users/samuel/Desktop/10academy/Twitter-Data-Analysis/data/Economic_Twitter_Data.json")
